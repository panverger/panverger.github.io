 ...
 * Sun Jun 06 2021 20:17:44 GMT+0300 (Θερινή ώρα Ανατολικής Ευρώπης)
...
registerOnClick('order_button', false, false, [0,1,2], function() {
  final_cost = parts_cost[0] + parts_cost[1];
  placeOrder('http://www.iekreth.gr/', 'Jewelry configurator', 'Your order is: ' + String(String(checkout_list[0]) + String(checkout_list[1])), String(final_cost) + '€', true);}, function() {});
